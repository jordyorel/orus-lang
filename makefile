...
VM_SRCS = $(SRCDIR)/vm/vm_core.c $(SRCDIR)/vm/vm.c $(SRCDIR)/vm/vm_memory.c $(SRCDIR)/vm/debug.c $(SRCDIR)/vm/builtins.c $(SRCDIR)/vm/vm_arithmetic.c $(SRCDIR)/vm/vm_control_flow.c $(SRCDIR)/vm/vm_typed_ops.c $(SRCDIR)/vm/vm_string_ops.c $(SRCDIR)/vm/vm_dispatch_switch.c $(SRCDIR)/vm/vm_dispatch_goto.c $(SRCDIR)/vm/vm_validation.c $(SRCDIR)/type/type_representation.c $(SRCDIR)/error_reporting.c
