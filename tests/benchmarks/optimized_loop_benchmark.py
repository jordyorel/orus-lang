#!/usr/bin/env python3
"""Optimized Loop Benchmark - Python"""
...
def optimized_loop_benchmark() -> None:
    ...
    trials_float = float(TRIALS)
    print("average_simple:", total_simple / trials_float)
    print("average_nested:", total_nested / trials_float)
    print("average_array:", total_array / trials_float)
    print("checksum:", checksum)
    print("=== Benchmark complete ===")
    print("Elapsed total:", total_elapsed)


if __name__ == "__main__":
    optimized_loop_benchmark()
