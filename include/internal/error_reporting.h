 ...
 * Description: Internal helpers for collecting, formatting, and flushing runtime
 *              error reports.
 */
...
typedef enum {
    ...
    E1019_MISSING_PRINT_SEPARATOR = 1019,
    ...
    E1410_NON_EXHAUSTIVE_MATCH = 1410,
    E1411_DUPLICATE_MATCH_ARM = 1411,
    ...
    E2009_ARGUMENT_COUNT_MISMATCH = 2009,
