 ...
 * Description: Aggregated code generation interface exposing the specialized
 *              compilation helpers for expressions, statements, functions,
 *              and module import/export handling.
 */
